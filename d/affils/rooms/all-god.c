...
void reset(status arg) {
  ...
  set_weather(2, 0, 0);
  set_affiliation_sponsor("the All-God");
  set_affiliation_name("follower of the All-God");
  set_affiliation_file("all-god");
  set_skills_file("/obj/skills/affils/all-god");
 ...
 */
  ...
  set_titles(({ 
        ...
        "the Humble Preceptor",                     
        "the Devout Preceptor",                     
        "the Humble Priestess",                   
        "the Devout Priestess",                  
        "the Humble Matriarch",                    
        "the Devout Matriarch",                    
        "the Humble Clerist",                      
        "the Devout Clerist",                      
        "the Humble High Clerist",                 
        "the Devout High Clerist",               
        "the Humble High Priestess",                  
        "the Devout High Priestess",                  
        "the Humble Prophet",                      
        "the Devout Prophet",                      
