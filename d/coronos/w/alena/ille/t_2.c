...
void reset (status arg){
    ...
    set_long(
      "West Temple runs north and south, its walkway paved with alternating \n"+
      "red and brown brick. A large temple rises up to the east, behind tall \n"+
    ...
    set_weather(2, 4, 0);
    set_exits(({
	"/d/coronos/w/alena/ille/t_1","north",
	"/d/coronos/w/alena/ille/t_3","south",
      }));
}
