...
void reset (status arg){
    ...
    set_long(
      "Many red and brown bricks line the pathway of East Temple, a \n"+
      "line of bushes and trees stand to the sides, blocking the temple \n"+
      "to the west almost completely.");
    set_day_desc(
    ...
    set_weather(2, 4, 0);
    set_exits(({
	"/d/coronos/w/alena/ille/t_9","north",
	"/d/coronos/w/alena/ille/t_7","south",
      }));
}
