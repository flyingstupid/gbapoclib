...
void reset(status arg) {
  ...
  if(arg) return;
    ...
    set_long(
	"The barracks of the 12th garrison are far from spartain, containing all   \n"+
	"the luxuries of a fine home. Decorating the walls are shields and banners \n"+
	"from all the campaigns this infantry has fought in. A sign of bronze hangs\n"+
	"on one of the walls.\n");
    ...
    set_exits(({   
	"d/coronos/w/angel/city/barracks/hall1", "west",
    }));
    set_weather(2, 0, 0);
