...
if(!present("board")) {
  ...
  board -> set_save_file("ob_saves/thief_board");
  board -> set_short("A Thief's Suggestion/Comment Board");
...
*/
  ...
  set_items(({
     "crate#crates", "Several crates of assorted items lie scattered \n"+
                     ...
                     "grand master thief who trains young thiawes here",
  ...
  set_weather(2, 1, 0);
  set_exits(({ "room/city/thief/tunnel9", "north" }));
