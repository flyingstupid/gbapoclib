...
void reset(status arg) {
  ...
  set_weather(0, 1, 0);
  set_long(
"There is a distinct smell of dung and methane in the air here. \n"+
"The air is cold and chilly made worsened by the cold water     \n"+
"washing away at a fast rate to the south.\n");
