...
void reset(status arg) {
  ...
  set_weather(0, 1, 0);
  set_long(
"The sewer comes to a dead end here. The end looks as though it \n"+
"may once have been free flowing, but years of decay have blocked\n"+
"its out flow. The smell of methane is strongest here.\n");
