...
#define BARD_GUILD "d/affils/rooms/bard"
/* fn specs */
...
void reset(status arg) {
  ...
  set_weather(2,1,0);
  set_long(
"The library of the University of Power is one of the best public \n"+
"libraries in all of the middle realms. Here, all mannor of tomes \n"+
"and books can be found even for the average citizen. The shelves \n"+
"are pilled high toward the ceiling covered in an elaborate frescoe.\n");
  ...
  set_sign_message(
     "\t-=[ The University of Power Library ]=-  \n"+
  ...
  set_items(({
	...
	"book#books#tome#tomes",
	"There are all mannor of items for you to read, but perhaps you \n"+
	"should browse the catalogue before you borrow something?\n",

	"shelf#shelves",
	"The shelves are made from a sturdy, yet ancient red wood, donated \n"+
	"by the elves of Scianthian. Such is the tradition among elvish    \n"+
	"peoples to donate items carved from the trees they guard.\n",

	"ceiling#vaulted ceiling",
	"High above you, covered in shadow, is the ceiling of the library",

	"shadow#shadows",
	"Who knows what lurks within them...\n",

	"frescoe",
	"The frescoe depicts the construction of the university amid the \n"+
	"battles that marked the founding of the city. There is the magic\n"+
	"battle of the dark elves of the north and Ille Coronos, as well \n"+
	"as the final stand at Sillin between the forces of light and the\n"+
	"darkness of the evil elves,\n",
