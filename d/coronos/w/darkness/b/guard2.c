/* Angel's guard1.c with an added set wander */
/* Bureaucracy Guard */
...
void reset(status arg) {
  ...
  if(arg) make_items();
    ...
    set_long(
       "This is a simple city guard from Ille Coronos.  He looks\n"+
       "fully alert and ready for the slightest sign of trouble\n"+
       "as he patrols the halls of the Bureaucracy.\n");
    ...
    load_chat(3, ({ "Guard says: Ok, move along, no loitering thankyou.\n",
