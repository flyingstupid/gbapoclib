...
void reset (status arg){
  ...
  reset_doors(arg);
  load_door(({
    "destination",      "d/coronos/w/russkie/rooms/21",
    "direction",        "oak door",
  ...
  load_door(({
    "destination",      "d/coronos/w/darkness/b/room1",
  ...
  set_long(
    ...
    "decorated with various pieces of framed artwork.  The halls to the east\n"+
    "and southeast are lined with many doors.\n");
  set_items(({
    "wall#walls",
  ...
  set_exits(({ 
      "d/coronos/w/darkness/b/hall/hall2", "east",
      "d/coronos/w/darkness/b/hall/hall8", "southeast",
      }));
