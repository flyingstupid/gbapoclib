...
#include <mudlib.h>
#include "/d/coronos/w/darkness/b/library/library.cfg"
...
void reset(status arg) {
  ...
  set_weather(2,1,0);
  set_long(
    "Shelves full of books line the walls of the library.  The great\n"+
    "wooden shelves rise almost to the top of the vaulted ceiling, with\n"+
    "each group of shelves seperated by a thin window.  A few silver\n"+
    "chandeliers hang down on long silver chains from thick wooden beams\n"+
    "that support the stone ceiling.  Tables and chairs sit upon the\n"+
    "hardwood floor of the great library.\n");      
  set_short("The Ille Coronos Public Library");

  set_sign_message(
"\t-=[  The Ille Coronos Public Library  ]=-  \n"+
     "Commands: borrow <book name>        \n"+
     "          return <book name>        \n"+
     "          browse <catalogue|index>  \n");
 
  set_smell("The musty scent of ancient leathers abound in the library.\n");
  set_listen("Footsteps echo in the hallway outside.\n");
 
  set_items(({
    "floor#hardwood",
      "The cedar floor is nicely polished.\n",
    "table#tables",
      "The tables are simply crafted from oak.\n",
    "chair#chairs",
      "The chairs are simply crafted from oak.\n",
    "beams#beam#wood beams#wooden beams",
      "The thick beams that support the ceiling are made frmo sturdy oak.\n",
    "chandeliers#chandelier",
      "The silver chandeliers are elegantly crafted out of the finest materials.\n",
    "chain#chains",
      "The silver chanderliers hang from these think, long chains.\n",
    "window",
      "The thin windows rise almost to the top of the vaulted ceiling.  Each\n"+
      "window seperates a group of wooden shelves.\n",
    "up#ceiling",
      "The vaulted ceiling is made from granite, supported by thick wood beams.\n",
    "books",
      "The books of the library all look very old.\n",
    "shelf#shelves",
      "The shelves are crafted from old oak.  They are lined all along the\n"+
      "walls, full of old books.\n",
    "wall#walls",
      "The granite walls of the library are lined with wooden shelves.\n",
  }));
