...
void reset(status arg) {
    ...
    set_long(
      "The flare of your light source throws your shadow grotesquely in front\n"+
      "of you.  It shows the grooves in the floor where something had dragged \n"+
      "itself to daylight, and on walls and roof the scratches and marks of \n"+
      "some very large creature.\n");
    set_items(({
    ...
    set_exits(({
	"d/coronos/w/miette/lairb", "west",
	"d/coronos/w/miette/lair", "east",
      }));
    set_weather(1,4,0);
}
