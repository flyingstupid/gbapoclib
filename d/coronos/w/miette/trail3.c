...
void reset(status arg) {
    ...
    set_long(
      "You see jubilantly green-tipped elders and clusters of moschatel \n"+
      "and lots of woodsorrel, the most delicate of flowers.  Higher up the \n"+ 
      "slope are the white heads of anemones, and beyond them are deep \n"+ 
      "emerald green drifts of delicate bluebell leaves and flowers.  To the\n"+
      "west thru a thicket you can make out an adit or mine opening.\n");
    set_day_desc(
    ...
    set_items(({
	"adit#mine#opening",
	"It appears to be the opening to a mine.\n",
    ...
    set_exits(({
	"d/coronos/w/miette/trail4", "north",
	"d/coronos/w/miette/trail2", "south",
	"d/coronos/w/miette/lair", "adit",
      }));
    set_weather(1,4,0);
}
