...
void reset(status arg) {
    ...
    set_long(
      "The path moves through the trees to the west, curves slightly until \n"+
      "it is stopped by an ivy-grown stone wall, and sinks in a deeply shadowed\n"+ 
      "transverse gully.  South, the path returns to its way along the cliffs.\n");
    set_day_desc(
    ...
    set_exits(({
	"d/coronos/w/miette/trail4", "south",
      }));
    set_weather(1,4,0);
}
void init() {
