...
void reset (status arg){
  ...
  set_long(
    ...
    "a good deal away from the city, at a small farm.");
  set_day_desc(
    "  The blue sky, and\n"+
    "the warm sun bring about a peacefull atmosphere here.\n");
  set_night_desc(
    "  The atmosphere\n"+
    "is very peacfull all along this path.  The silvery moon, and the\n"+
    "many stars illuminate the quiet, night sky.\n");
  set_items(({
    "farm",
      "The farm is far to the north.\n",
    "horizon",
    ...
    "path#down#ground",
      ...
      "definitely only a path despite it's long stretch towards the farm\n"+
      "in the distance.\n",
    "dirt",
    ...
    "Ille Coronos#city",
      "The city of Ille Coronos lies to the southwest.  Its walls and a\n"+
      "few building tops can be seen.\n",
    "walls",
  ...
  set_exits(({
      "/d/coronos/w/newstar/newbie/rooms/path2.c", "northeast",
      "/room/newbie/road2", "southwest",
      }));
}
