...
if(!present("anthony")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/anthony"),this_object());
}

if(!present("kenny")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/kenny"),this_object());
}
