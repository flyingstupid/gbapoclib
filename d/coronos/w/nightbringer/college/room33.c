...
if(!present("george")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/george"),this_object());
}

if(!present("thor")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/thor"),this_object());
}
