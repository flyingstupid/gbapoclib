...
if(!present("jack")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/jack"),this_object());
}

if(!present("john")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/john"),this_object());
}
