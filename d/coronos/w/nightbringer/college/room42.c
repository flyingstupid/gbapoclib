...
void reset(status arg) {
  ...
  reset_doors(arg);
  load_door(({
    "destination", "d/coronos/w/nightbringer/college/room49",
    "direction", "west door",
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/college/room56",
    "direction", "east door",
    "description", "A plain wooden door .\n",
    "closed",
    "door number", 2,
...
"burnt wooden doors#burnt wooden door#wooden doors#wooden door#doors#door",
  ...
  set_exits(({
     "d/coronos/w/nightbringer/college/room41", "south",
     "d/coronos/w/nightbringer/college/room43", "north",
       }));
  set_weather(1,2,0);    
}
