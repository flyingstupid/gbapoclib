...
if(!present("tasha")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/tasha"),this_object());
}

if(!present("shiva")) {
move_object(clone_object("d/coronos/w/nightbringer/college/npc/shiva"),this_object());
}
