...
if(arg) return;
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_22.c",
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_15.c",
...
set_weather(2,2,0);
  set_exits(({
        "d/coronos/w/nightbringer/manor/manor_19.c",  "east",
"d/coronos/w/nightbringer/manor/manor_23.c",   "west",
}));
