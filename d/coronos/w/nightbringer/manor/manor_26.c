...
reset_doors(arg);
  ...
  load_door(({
     "file", "d/coronos/w/nightbringer/manor/manor_25.c",
  ...
  if(!present("gwyn")) {
       move_object(clone_object("d/coronos/w/nightbringer/manor/mon/gwyn.c"),this_object());
       }
if(arg) return;
...
"small bed, a stool, and a bedside table in here.\n");
  ...
  set_items(({
"wall#walls",  "They are made of wood\n",
