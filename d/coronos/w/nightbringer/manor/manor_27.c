...
if(arg) return;
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_28.c",
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_18.c",
...
set_weather(2,2,0);
  set_exits(({
        "d/coronos/w/nightbringer/manor/manor_25.c",  "east",
  }));
