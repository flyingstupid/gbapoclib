...
void reset(status arg) {
  ...
  load_door(({
     "file", "d/coronos/w/nightbringer/manor/manor_34.c",
     "direction", "west door",
     "long",
          "A plain wooden door.\n",
     "open",
  ...
  if(!present("magus sapelite")) {
       move_object(clone_object("d/coronos/w/nightbringer/manor/mon/sapelite.c"),this_object());
       }
  if(arg) return;
...
"A large rolltop desk is in the nothwest corner of the room and a \n"+
