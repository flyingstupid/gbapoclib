...
void reset(status arg) {
  ...
  if(arg) return;
  load_door(({
"destination",  "d/coronos/w/nightbringer/manor/manor_37.c",
    "direction", "west door",
...
"condition.\n",
  ...
  set_weather(2,2,0);
  set_exits(({
        "d/coronos/w/nightbringer/manor/manor_38.c",  "south",
        "d/coronos/w/nightbringer/manor/manor_34.c",  "north",
        "d/coronos/w/nightbringer/manor/manor_29.c",  "east",
  }));
