...
void reset(status arg) {
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_43.c",
    "direction", "east door",
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_39.c",
    "direction", "west door",
    "description", "A plain wooden door .\n",
    "closed",
    "door number", 2,
...
"condition.\n",
  ...
  set_weather(2,2,0);
  set_exits(({
        "d/coronos/w/nightbringer/manor/manor_40.c",  "south",
        "d/coronos/w/nightbringer/manor/manor_36.c",  "north",
  }));
