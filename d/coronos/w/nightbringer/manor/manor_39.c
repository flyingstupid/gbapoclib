...
void reset(status arg) {
  ...
  load_door(({
     "file", "d/coronos/w/nightbringer/manor/manor_38.c",
     "direction", "east door",
     "long",
          "A plain wooden door.\n",
     "open",
  ...
  if(!present("duke rochester")) {
       move_object(clone_object("d/coronos/w/nightbringer/manor/mon/dukeroch.c"),this_object());
       }
  if(arg) return;
