...
void reset(status arg) {
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_42.c",
    "direction", "east door",
  ...
  load_door(({
    "destination", "d/coronos/w/nightbringer/manor/manor_41.c",
    "direction", "west door",
    "description", "A plain wooden door .\n",
    "closed",
    "door number", 2,
...
"condition.\n",
  ...
  set_weather(2,2,0);
  set_exits(({
        "d/coronos/w/nightbringer/manor/manor_38.c",  "north",
  }));
