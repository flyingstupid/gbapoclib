...
void reset(status arg) {
  ...
  set_long(
"The starange wailing sounds decrease in volume a little as you\n"+
"head east. Strange flickering shadows dance along the walls like\n"+
"a twisted pupet show.\n");
...
"natural.\n",
  ...
  set_weather(0,2,0);
  set_exits(({
        "d/coronos/w/nightbringer/manor/manor_57.c", "west",
           }));
}
