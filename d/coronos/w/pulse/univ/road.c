...
void reset(int arg) {
  ...
  set_long(
    ...
    "sections of the College for Extraphysical Studies, the university\n"+
    "where all aspiring mages eventually find themselves.\n"
  );
  ...
  set_items(( {
    ...
    "magnificently crafted.  The arch bridges the left and right halves of\n"+
    "the college.  Mages spare no expense for their own comfort and \n"+
    "furnishings.\n",
    
    "school",
    "The famed College for Extraphysical Sciences in Ille Coronos lies\n"+
  ...
  set_exits(( {
    ...
    "/d/coronos/w/darkness/univst2", "southwest"
  }));
