...
inherit ROOM;
  ...
  load_door(({
    "file",     "players/russkie/tavern/room1",
    "direction", "south door",
    "long", "A strong maple door.\n",
    "closed",
    "locked",
    "lock id", "lock",
    "lock description", "A small silver lock with the number 1 on it.\n",
...
glow emitted from small torches ensconced on the walls, creating\n\
shadows across the room doors. The floor is covered in a soft blue\n\
rug, and a window at the end of the hall is boarded up.\n");
  set_exits(({
"/d/coronos/w/russkie/rooms/hall2", "west",
"/d/coronos/w/russkie/rooms/lobby", "east",
}));
  set_items(({
"floor#rug",
