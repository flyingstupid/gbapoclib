...
inherit ROOM;
  ...
  load_door(({
    "file",     "/d/coronos/w/russkie/rooms/room2",
    "direction", "north door",
    "long", "A strong maple door.\n",
    "closed",
    "locked",
    "lock id", "lock",
    "lock description", "A small silver lock with the number 2 on it.\n",
...
shadows across the room doors. The floor is covered in soft blue\n\
rug, and the window at the end of the hall is boarded up.\n");
  set_exits(({
"/d/coronos/w/russkie/rooms/hall3", "west",
"/d/coronos/w/russkie/rooms/hall1", "east",
}));
  set_items(({
"floor#rug",
