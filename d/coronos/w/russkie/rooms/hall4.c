...
inherit ROOM;
  ...
  load_door(({
    "file",     "/d/coronos/w/russkie/rooms/room4",
    "direction", "north door",
    "long", "A strong maple door.\n",
    "closed",
    "locked",
    "lock id", "lock",
    "lock description", "A small silver lock with the number 4 on it.\n",
...
rug, and the window at the end of the hall is boarded up.\n");
  set_exits(({
"/d/coronos/w/russkie/rooms/hall5", "west",
"/d/coronos/w/russkie/rooms/hall3", "east",
}));
  set_items(({
"floor#rug",
