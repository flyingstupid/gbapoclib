...
void reset(status arg) {
  ...
  reset_doors(arg);
  load_door(({
    "destination", "/d/coronos/w/ ",
    "direction", "oak door",
    "long", "This is a large door made of solid oak.\n",
    "door id", "oak door",
    "key id", "iron beurocracy key",
    "lock id", "iron beurocracy lock",
    "lock description", "An old iron lock\n",
    "lock difficulty", 900,    /* Area temporarily closed */
    "closed", 
  }));
