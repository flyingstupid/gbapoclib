...
void reset(status arg)
{
   ...
   {
      load_door(({
         "destination", "d/ooc/w/jheleg/bhouse/gamerm",
         "direction",   "east door",
         "closed",
         "description",
      ...
      set_long(
         ...
         "  places that bear some relevance to the locale.  A utility\n"+
         "  room of sorts is north of here with another room to the  \n"+
         "  east.                                                    \n"
      );
      set_items(({
            "carpet#shag carpet",
