...
reset (arg) {
  ...
  set_long("This is the southern end of the dining hall, filled with\n"+
     "tables and chairs for the students to eat at. A large fireplace\n"+
     "is in the southern wall, and is not lit. Banners proclaiming the\n"+
  ...
  set_exits(({"/d/tempus/w/serepion/school9.c", "north"}));
}
