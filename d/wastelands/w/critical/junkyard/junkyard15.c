...
void reset(status arg) {
    ...
    set_long(
        ...
        "north and south. Heavy foot tracks lead in both directions and there\n"+
		"are tracks and trails from something having been dragged from one of\n"+
		"the huge piles of junk.\n");
    set_exits(({"d/wastelands/w/critical/junkyard/junkyard20","north",
	"d/wastelands/w/critical/junkyard/junkyard10","south"}));
}