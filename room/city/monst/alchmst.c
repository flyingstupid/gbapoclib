/* THE ALCHEMIST!  -   Angel, March 1994
...
#define VALUE_MOD        20
#define COST_MOD         300
#define DIFFICULTY       15   /* thorins difficulty to make items         */
#define ABILITY          20   /* thorins ability to make items            */
...
void set_potion_array(string *arr) { potion_array = arr; }
